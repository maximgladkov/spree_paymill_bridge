...
# Requires factories defined in lib/spree_paymill_bridge/factories.rb
require 'spree_paymill_bridge/factories'
...
RSpec.configure do |config|
  ...
  # will be unavailable to the browser, which runs under a separate server instance.
